            ...
            <div v-else class="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <div class="lg:col-span-1">
                    <div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6 sticky top-4">
                        ...
                        <button
                            class="w-full bg-blue-600 text-white py-3 px-4 rounded-md font-semibold hover:bg-blue-700 transition-colors"
                        >
                            Proceed to Checkout
                        </button>
                        ...
                        <Link
                            href="/products"
                            class="mt-4 block w-full text-center bg-gray-100 text-gray-900 py-3 px-4 rounded-md font-semibold hover:bg-gray-200 transition-colors"
                        >
                            Continue Shopping
                        </Link>
                    </div>
