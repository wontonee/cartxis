...
import { Plus, GripVertical, Trash2, Eye, EyeOff, Edit } from 'lucide-vue-next';
              ...
              <template v-for="item in parentItems" :key="item.id">
                ...
                >
                  ...
                  <td class="whitespace-nowrap px-6 py-4 text-right text-sm font-medium">
                    <div class="flex items-center justify-end gap-2">
                      <button @click="toggleActive(item)" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" :title="item.active ? 'Deactivate' : 'Activate'">
                        <Eye v-if="item.active" class="h-4 w-4" />
                        <EyeOff v-else class="h-4 w-4" />
                      </button>
                      <button @click="handleEdit(item)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                        <Edit class="h-4 w-4" />
                      </button>
                      <button @click="handleDelete(item)" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                ...
                >
                  ...
                  <td class="whitespace-nowrap px-6 py-3 text-right text-sm font-medium">
                    <div class="flex items-center justify-end gap-2">
                      <button @click="toggleActive(child)" class="text-gray-400 hover:text-gray-600 dark:hover:text-gray-300" :title="child.active ? 'Deactivate' : 'Activate'">
                        <Eye v-if="child.active" class="h-4 w-4" />
                        <EyeOff v-else class="h-4 w-4" />
                      </button>
                      <button @click="handleEdit(child)" class="text-blue-600 hover:text-blue-900 dark:text-blue-400 dark:hover:text-blue-300">
                        <Edit class="h-4 w-4" />
                      </button>
                      <button @click="handleDelete(child)" class="text-red-600 hover:text-red-900 dark:text-red-400 dark:hover:text-red-300">
                        <Trash2 class="h-4 w-4" />
                      </button>
                    </div>
                  </td>
