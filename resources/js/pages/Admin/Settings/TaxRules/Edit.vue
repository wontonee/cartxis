<template>
  <AdminLayout title="Edit Tax Rule">
    <template #default>
      <div class="max-w-4xl mx-auto">
        <!-- Header -->
        <div class="mb-6">
          <h1 class="text-3xl font-bold text-gray-900">Edit Tax Rule</h1>
          <p class="mt-2 text-sm text-gray-600">Update tax rule configuration</p>
        </div>
          ...
          <form @submit.prevent="submit">
            ...
            <div class="flex justify-end space-x-3 pt-4 border-t border-gray-200">
              ...
              >
                ...
                <span v-else>Update Tax Rule</span>
              </button>
            </div>
          </form>
        </div>
