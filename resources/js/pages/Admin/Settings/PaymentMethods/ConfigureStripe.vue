    ...
    <div class="p-6">
      ...
      <div class="mb-6">
        <div class="flex items-center justify-between mb-6">
          <div>
            <h1 class="text-2xl md:text-3xl text-gray-800 font-bold">Stripe Configuration</h1>
            <p class="text-sm text-gray-600 mt-1">Configure Stripe payment gateway settings</p>
          </div>
          <a 
          ...
          <div class="space-y-4">
            ...
            <div>
              ...
              <input
                ...
                type="password"
                :class="['w-full px-3 py-2 border rounded-lg focus:ring-2 focus:ring-blue-500 focus:border-transparent font-mono text-sm', errors['configuration.secret_key'] ? 'border-red-500' : 'border-gray-300']"
                placeholder="sk_live_..."
              />
              <p v-if="errors['configuration.secret_key']" class="mt-1 text-sm text-red-600">{{ errors['configuration.secret_key'] }}</p>
              <p class="mt-1 text-xs text-gray-500">Starts with <code class="bg-gray-100 px-1 rounded">sk_</code></p>
            </div>
