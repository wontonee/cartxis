...
namespace Vortex\Setup\Services;
...
class DemoDataService
{
    ...
    private const BUSINESS_TYPES = [
        'retail' => [
            ...
            'seeders' => [
                \Vortex\Setup\Database\Seeders\RetailDemoSeeder::class,
            ],
        ],
        'kirana' => [
            ...
            'seeders' => [
                \Vortex\Setup\Database\Seeders\KiranaDemoSeeder::class,
            ],
        ],
        'electronics' => [
            ...
            'seeders' => [
                \Vortex\Setup\Database\Seeders\ElectronicsDemoSeeder::class,
            ],
        ],
        'fashion' => [
            ...
            'seeders' => [
                \Vortex\Setup\Database\Seeders\FashionDemoSeeder::class,
            ],
        ],
    ];
