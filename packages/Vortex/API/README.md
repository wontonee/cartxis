...
> RESTful API package for Vortex eCommerce platform - Mobile app backend
...
```json
{
    "extra": {
        "laravel": {
            "providers": [
                "Vortex\\API\\Providers\\APIServiceProvider"
            ]
        }
    }
}
...
MIT License - Part of Vortex eCommerce Platform
