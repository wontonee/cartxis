...
namespace Vortex\Shop\Http\Controllers\Checkout;
...
use Vortex\Shop\Services\CheckoutService;
use Vortex\Shop\Models\ShippingMethod;
...
class CheckoutController extends Controller
{
    ...
    {
        $order = \Vortex\Shop\Models\Order::with(['items', 'addresses'])
            ->where('id', $order)
            ->firstOrFail();
