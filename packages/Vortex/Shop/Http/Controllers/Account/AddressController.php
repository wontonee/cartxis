...
use Vortex\Shop\Http\Controllers\Controller;
...
class AddressController extends Controller
{
    ...
    {
        $addresses = Address::where('addressable_type', 'Vortex\Shop\Models\User')
    ...
    public function store(Request $request)
    {
        ...
        if ($validated['is_default'] ?? false) {
            Address::where('addressable_type', 'Vortex\Shop\Models\User')
                ->where('addressable_id', auth()->id())
        ...
        $address = Address::create([
            'addressable_type' => 'Vortex\Shop\Models\User',
    ...
    public function update(Request $request, Address $address)
    {
        ...
        if ($address->addressable_type !== 'Vortex\Shop\Models\User' || $address->addressable_id !== auth()->id()) {
    ...
    public function destroy(Address $address)
    {
        ...
        $addressCount = Address::where('addressable_type', 'Vortex\Shop\Models\User')
            ->where('addressable_id', auth()->id())
            ->count();
        ...
        if ($address->is_default) {
            $newDefault = Address::where('addressable_type', 'Vortex\Shop\Models\User')
                ->where('addressable_id', auth()->id())
                ->where('id', '!=', $address->id)
                ->where('type', $address->type)
                ->first();
