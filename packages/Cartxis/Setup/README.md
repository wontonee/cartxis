...
The Setup Wizard provides a first-time installation experience for the Cartxis eCommerce platform. It allows users to select their business type and import relevant demo data to get started quickly.
...
1. **Create Seeder**
```php
// packages/Cartxis/Setup/src/Database/Seeders/YourBusinessSeeder.php
...
private const BUSINESS_TYPES = [
    'your-business' => [
        ...
        'seeders' => [
            \Cartxis\Setup\Database\Seeders\YourBusinessSeeder::class,
        ],
    ],
];
```
...
```bash
php artisan db:seed --class=Cartxis\\Setup\\Database\\Seeders\\RetailDemoSeeder
```
...
**Built for:** Cartxis Open-Source eCommerce Platform  
