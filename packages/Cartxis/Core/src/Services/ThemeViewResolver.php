...
class ThemeViewResolver
{
     ...
     * 
     * @example
    * // Returns: 'themes/cartxis-default/pages/Products/Index'
     * $resolver->resolve('Products/Index');
     * 
    * // If custom theme overrides, returns: 'themes/cartxis-christmas/pages/Products/Index'
    * $resolver->resolve('Products/Index'); // with active theme = cartxis-christmas
     */
     ...
     * 
    * Converts: themes/cartxis-default/resources/views/pages/Products/Index.vue
    * To: themes/cartxis-default/pages/Products/Index
     * 
     * @param string $theme Theme name
     * @param string $view View name
