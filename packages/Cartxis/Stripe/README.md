...
A complete Stripe payment gateway integration for Cartxis Commerce Platform.
...
```bash
cd /path/to/cartxis
composer require cartxis/stripe
```
...
- **Documentation**: https://docs.cartxis-commerce.com/stripe
- **Stripe Docs**: https://stripe.com/docs
- **Issues**: https://github.com/cartxis/stripe/issues
